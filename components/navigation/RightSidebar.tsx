...
const RightSidebar = () => {
  return (
    <section className="pt-36 custom-scrollbar background-light900_dark200 border-light border-l sticky right-0 top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto shadow-light-300 dark:shadow-none max-xl:hidden p-6">
      <div>
